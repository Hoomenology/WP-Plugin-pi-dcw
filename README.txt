...
Add to cart will redirects you to the checkout page or your selected custom page, Quick purchase button WooCommerce, Buy now button WooCommerce, Quick View product
...
Yes you can do that in the pro version, in the pro version you have the option to enter the list of a domain name where you want to redirect, if the external URL domain is in this list then redirect will be done, if it is not in this list then redirect to that domain will not work
...
Yes you can do that using the Pro version it gives you the option to link product name on the checkout page to there respective product pages
